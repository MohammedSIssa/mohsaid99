...
export default function PostImages({ images }: { images: string[] }) {
  ...
  return (
    <div className="slider flex max-h-full min-h-[200px] w-full max-w-full items-start justify-start gap-2 overflow-x-auto overflow-y-hidden rounded-2xl border-2 border-white/10 bg-white/10 p-4">
