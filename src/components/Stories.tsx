    ...
    >
      ...
      {stories?.map((story, idx) => {
        const linkClasses = showNav
          ? `${story.special ? "border-yellow-400/70 bg-yellow-900/50 text-yellow-200" : "border-(--border-color)"} p-2 min-h-16 relative transition-transform duration-300 opacity-100 max-w-full border-2  rounded-lg`
