...
import { IoStatsChartOutline } from "react-icons/io5"; // inactive
import { IoStatsChart } from "react-icons/io5"; // active
...
const Navbar = () => {
  ...
  const { latestGoal, latestWeek, latestPost, latestStat } = dataCenter;
